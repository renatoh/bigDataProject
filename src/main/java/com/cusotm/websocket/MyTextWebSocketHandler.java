...
public class MyTextWebSocketHandler extends TextWebSocketHandler {
    ...
    //curl call to test WebSocket  
//    curl     --include     --no-buffer     --header "Connection: Upgrade"     --header "Upgrade: websocket" 
//    --header "Host: example.com:80"     --header "Origin: http://example.com:80"     --header "Sec-WebSocket-Key: SGVsbG8sIHdvcmxkIQ==" 
//    --header "Sec-WebSocket-Version: 13"     http://84.20.60.172:8080/web-socket
